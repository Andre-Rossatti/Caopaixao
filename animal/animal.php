...
<nav class="navbar px-md-0 navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container-fluid px-md-5">
			<table>
				<tr>
				  <td> <a class="navbar-brand" href="index.html">Cão Paixao <span>Aqui caosigo um amigo</span></a></div>
...
<section class="ftco-section ftco-no-pt">
	<div class="container">
		<?php 
                    $idAnimal = $_GET["id"];
					$consulta_animais=$conn-> prepare("SELECT animais.id_animal As id_animal, animais.arquivo As Foto, animais.nome_animal As animal, animais.cor as Cor, animais.raca as raca, animais.idade as Idade, animais.especie as especie, animais.sexo as sexo, animais.porte as porte, animais.comentarios as Comentarios, usuarios.nome AS proprietario, usuarios.email As Email, usuarios.cidade as Cidade, usuarios.telefone as Telefone from animais inner JOIN usuarios on animais.id_user = usuarios.id_user where id_animal = :id_animal ");
             
                    $consulta_animais -> bindvalue (":id_animal", $idAnimal);
		...
		?>
        <div class="row">
                <h2 class="mb-4" style="font-size:50px; text-align: center; justify-content: center;"><strong> <?php echo $row["animal"]; ?></strong></h2>&nbsp;
                </h2>
        </div>

        <div class="row">
            <div class"col float-left">
                <img style = "width: 600px; height: 450px; margin-right: 50px" src="../perfil/<?php echo $row["Foto"]; ?>">
            </div>

            <div class"col float-right">
                <p style = "font-size: 25px; margin-right: 50px"><strong>Dados do Animal</strong></p>

          

                <strong style = "font-size:  20px;">Cor:</strong> <?php echo $row["Cor"]; ?>&nbsp;
                <br> 
                <strong style = "font-size:  20px;">Raça:</strong> <?php echo $row["raca"]; ?>&nbsp;
                <br>
                <strong style = "font-size:  20px;">Idade:</strong> <?php echo $row["Idade"]; ?>&nbsp;
                <br>
                <strong style = "font-size: 20px;">Espécie:</strong> <?php echo $row["especie"]; ?>&nbsp;
                <br>
                <strong style = "font-size:  20px;">Sexo:</strong> <?php echo $row["sexo"]; ?>&nbsp;
                <br>
                <strong style = "font-size: 20px;">Porte:</strong> <?php echo $row["porte"]; ?>&nbsp;
                <br>
                <strong style = "font-size:  20px;">Comentarios:</strong> <?php echo $row["Comentarios"]; ?>&nbsp;     
				
                 <p style = "font-size: 25px; margin-right: 50px"><strong>Dados do Usuario</strong></p>

                 <strong style = "font-size:  20px;">Proprietario:</strong> <?php echo $row["proprietario"]; ?>&nbsp;
<br>
                  <strong style = "font-size:  20px;">Email:</strong> <?php echo $row["Email"]; ?>&nbsp;
<br>
                   <strong style = "font-size:  20px;">Cidade:</strong> <?php echo $row["Cidade"]; ?>&nbsp;
<br>
<br>
                    <a href="tel:#"><span class="icon icon-phone" style = "font-size= 120%;"><strong> Telefone: </span><span class="text"><?php echo $row["Telefone"]; ?></strong></span></a>
                    <br>



                    <a href = "https://api.whatsapp.com/send?phone=<?= $row[Telefone]?>&text=ola%20vim%20%20pelo%20caopaixao"><img src = "zap.png" ></a>
...
<div class="row mb-5">
  <div class="col-md">
	<div class="ftco-footer-widget mb-4">
	  ...
	  <li><a href="../login/login.php" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Login</a></li>
